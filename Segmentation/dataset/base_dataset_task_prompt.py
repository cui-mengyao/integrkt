...
class BaseVolumeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print('2:', img_aug.shape, seg_aug.shape)
        return img_aug, seg_aug, np.array(img_vol.header.get_zooms())[self.spatial_index], cls_label, self.img_dict[idx]
